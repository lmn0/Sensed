This is a multi-tenant sensor cloud system. The sensor cloud enables users to add their sensor data to the cloud system thus allowing them to monitor the data in form of charts and other dashboards. 
